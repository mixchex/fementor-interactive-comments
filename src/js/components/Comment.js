        ...
        <>
            <Modal show={showModal}>
                ...
                <div className="comment__modal-buttons">
                    <button aria-label="Cancel Comment Deletion" onClick={() => setShowModal(false)}
                        className="comment__input-button"
                    >
                        No, Cancel
                    </button>
                    <button aria-label="Confirm Comment Deletion" onClick={handleCommentDelete}
                    ...
                    <div className="comment">
                        <div className="comment__aside">
                            <div className="comment__vote">
                                <button aria-label="Upvote Comment" onClick={handleUpVote} className="comment__vote-button">
                                ...
                                <button aria-label="Downvote Comment" onClick={handleDownVote} className="comment__vote-button">
                                    ...
                                    <span className="sr-only">Downvote Comment</span>
                                </button>
                            </div>
                        </div>
                        <div className="comment__main">
                            <div className="comment__head">
                                ...
                                <div className="comment__interactions">
                                    {commentData.user.username === currentUser.username ?
                                        <>
                                            <button aria-label="Delete Your Comment" onClick={() => setShowModal(true)} className="comment__quick-button comment__quick-button--delete">
                                            ...
                                            <button aria-label="Edit Your Comment" onClick={() => { setEditing(!editing); setCommentEditContent(commentData.content) }} className="comment__quick-button comment__quick-button--edit">
                                        ...
                                        :
                                        <button aria-label="Reply to Comment" onClick={() => setReply(!reply)} className="comment__quick-button comment__quick-button--reply">
                                ...
                                {editing ?
                                    <div>
                                        ...
                                        <div className="comment__input-update">
                                            <button aria-label="Update Comment" onClick={ handleCommentUpdate} className="comment__input-button comment__input-button--primary">
                                                Update
                                            </button>
                                        </div>
                                    </div>
